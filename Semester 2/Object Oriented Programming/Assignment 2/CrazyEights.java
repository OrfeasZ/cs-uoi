...
class Player
{
    ...
    Player(String p_Name, Type p_PlayerType)
    {
        m_Name = p_Name;
        m_Type = p_PlayerType;
    }
    ...
    private ArrayList<Integer> GetViableOptions()
    {
    ...
    private Card FindCardByID(int p_ID)
    {
    ...
    private boolean PlayNormalRound()
    {
        PrintHand();
    ...
    {
        return (m_Type == Type.Normal ? PlayNormalRound() : PlayAIRound());
    }
...
class Table
{
    ArrayList<Player> m_Players = new ArrayList<Player>();
    Deck m_Deck = new Deck();
    ArrayList<Card> m_TableCards = new ArrayList<Card>();
    int m_GetTwoCount = 0;
    Player m_Winner;

    Table(ArrayList<Player> p_Players)
    {
        m_Players = p_Players;
    ...
    public void PrintRoundInfo(Player p_Player)
    {
        Utils.ClearConsole();

        System.out.println("Player '" + p_Player.GetName() + "'" + (p_Player.GetType() == Player.Type.AI ? " [AI]" : "") + " is now playing (Cards: " + p_Player.GetHandCardCount() + ").\n\n");
    ...
    public Player GetWinner() { return m_Winner; }
}
...
class CrazyEights
{
    ...
    private static Player ReadNewPlayerInfo(Scanner p_Scanner, int p_Index)
    {
        Utils.ClearConsole();
        PrintLogo();
        ...
        return new Player(s_PlayerName, (s_PlayerType.equalsIgnoreCase("n") ? Player.Type.Normal : Player.Type.AI));
    }
    ...
    public static void main(String[] args)
    {
        ...
        ArrayList<Player> s_Players = new ArrayList<Player>();
